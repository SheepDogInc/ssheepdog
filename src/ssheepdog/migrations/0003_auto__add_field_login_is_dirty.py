...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Login.is_dirty'
        db.add_column('ssheepdog_login', 'is_dirty', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Login.is_dirty'
        db.delete_column('ssheepdog_login', 'is_dirty')
