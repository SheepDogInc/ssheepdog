...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Machine.is_down'
        db.add_column('ssheepdog_machine', 'is_down', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Machine.is_down'
        db.delete_column('ssheepdog_machine', 'is_down')
