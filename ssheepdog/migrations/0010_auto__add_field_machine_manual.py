...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Machine.manual'
        db.add_column('ssheepdog_machine', 'manual', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Machine.manual'
        db.delete_column('ssheepdog_machine', 'manual')
