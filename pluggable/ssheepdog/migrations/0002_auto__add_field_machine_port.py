...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Machine.port'
        db.add_column('ssheepdog_machine', 'port', self.gf('django.db.models.fields.IntegerField')(default=22), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Machine.port'
        db.delete_column('ssheepdog_machine', 'port')
